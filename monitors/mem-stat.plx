...
print "Totals(kb):\n";
printf '%6s %10s %10s %10s %10s %10s %10s %10s %10s', 'PID', 'RSS Bgn', 'RSS End', 'RSS Grwt', 
	'RSS Avg', 'VSZ Bgn', 'VSZ End', 'VSZ Grwt', 'VSZ Avg';
print "\n";
print '-' x 96;
print "\n";
...
while ( my ($key, $value) = each(%pid_mem))
{
	...
	printf '%6s %10d %10d %10d %10d %10d %10d %10d %10d', $key, $rss_begin, $rss_end, $rss_growth, 
		$rss_avg, $vsz_begin, $vsz_end, $vsz_growth, $vsz_avg;
	print "\n";
}
